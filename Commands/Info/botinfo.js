    ...
    cpuStat.usagePercent(function (error, percent) {
      ...
      const embed = new EmbedBuilder()
        ...
        .addFields(
          ...
          {
            name: "<:groupe:1192912597314437311>・**Développeur**",
            value: "> **Nom :** <@1008443203546009731> \n > **@slayer948** \n > **Identifiant :** 1008443203546009731 \n > **Date de création :** <t:1514161920:f> (<t:1514161920:R>)",
            inline: true
          },
          {
            name: "<:server:1192789640877457478>・**Statistique du bot**",
            value: `> **Bot démarer depuis :** \`${days}j ${hours}h ${minutes}m ${seconds}s\` \n > **Serveurs :** ${servers} \n > **Utilisateurs :** ${users} \n >  **Robots :** ${botCount} \n > **Boosts :** ${totalBoosts} \n > **Ping :** ${client.ws.ping} ms \n > **Version :** Béta`,
            inline: false
          },
          {
            name: "<:settings:1192853210445127690>・**Information techniques**",
            value: `> **Hébergeur :** HebergeHub \n > **Utilisation du CPU :** ${cpu} % \n > **Node.js :** ${node} \n > **Discord.js :** v${discordjsVersion}`,
            inline: false
          },
        )
